    ...
    return <div className="container">
      ...
      <div className="content">
        <div style={{ padding: "0 16px", textAlign: "center", margin: "auto", maxWidth: 311 }}>
          <BankTile name={name} imageRef={iconUrl} style={{ width: 160, margin: "auto" }} />
          <Spacer y={2} />
...

        {
          filteredBankData.length > 0 ?
            <div style={{ display: 'grid', gridTemplateColumns: "1fr 1fr", columnGap: 16, rowGap: 16 }}>
              {
                filteredBankData.map(datum => <BankTile key={datum.id} name={datum.name} imageRef={datum.iconUrl} onClick={() => handleChooseBank(datum)} />)
              }
            </div> :
            <div style={{ textAlign: "center" }}>
              <CircleIcon
