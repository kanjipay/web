...
function Accordion({ title, body }) {
  ...
  return (
    <div className="Home__accordion" onClick={() => setIsExpanded(!isExpanded)}>
...
function Testimonial({ name, company, body }) {
  return (
    <div className="Home__testimonialBox">
      <p
        style={{
      ...
      <div style={{ display: "flex", alignItems: "center", columnGap: 8 }}>
        <img
          className="Home__testimonialImage"
          style={{ backgroundColor: "gray" }}
          alt=""
        />
        <p>
          <span style={{ fontWeight: 800 }}>{name}</span> from{" "}
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center" }}>
          <div>
            <h2
              className="Home__headingLarge"
              style={{
                fontSize: isMobile ? "3rem" : "5rem",
              }}
            >
              Bring your menu online
            </h2>
            <Spacer y={4} />
            <p style={{ fontSize: 20 }}>
              Mercado is an online menu for food stalls. No set up fees. No
              subscription. All you need is a QR code.
            </p>
            <Spacer y={4} />
            <Link to="book-demo">
              <MainButton
                style={{ display: "inline", width: 140 }}
                title="Book a demo"
              />
            </Link>
          </div>
      ...
      >
        <Benefit
          ...
          body={`Our technology allows you to take payments with a direct bank transfer, instead of paying hefty card fees. This allows us to offer a market leading price of ${(
            transactionFee * 100
          ).toFixed(
            1
          )}% of each transaction, with no subscriptions, monthly minimums or setup costs.`}
        />
        <Benefit
      ...
      >
        ...
        <div style={{ display: "grid", rowGap: 16 }}>
          ...
          <Accordion
            ...
            body={`We charge a ${(transactionFee * 100).toFixed(
              1
            )}% fee on transactions processed through Mercado. There are no other fees. We can offer a 1 month free trial if your company meets certain criteria - contact us to find out more.`}
          />
        </div>
      </div>
