...
export function PriceComparer() {
  ...
  return <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", columnGap: 64, rowGap: 32 }}>
    <div>
    ...
    <div>
      ...
      {
        eventbriteEarnings < earnings && <div>
          <Spacer y={3} />
          <p style={{ textAlign: "center" }}>
            You'd only earn{" "}
            <span style={{ fontWeight: 600, color: Colors.RED }}>{formatCurrency(eventbriteEarnings, currency, false)}</span>
            {" "}with Eventbrite.
          </p>
        </div>
      }
