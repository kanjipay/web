...
export default function RegisteredConfirm() {
  ...
  />
    ...
    NetworkManager.post(ApiName.INTERNAL, '/payees/update',  paymentRegisterBody).then(setRegistered(true))
    return <LoadingPage iconBackgroundColor={Colors.BLACK} iconForegroundColor={Colors.WHITE}/>
  }
}