    ...
    <div className="container">
      ...
      <div className="content">
        ...
        <p className="text-disclaimer">
          This is a short disclaimer that needs to be here. This is a short
          disclaimer that needs to be here. This is a short disclaimer that
          needs to be here. This is a short disclaimer that needs to be here.
          This is a short disclaimer that needs to be here. This is a short
          disclaimer that needs to be here. This is a short disclaimer that
          needs to be here.
        </p>
