...
export default function PaymentPage() {
  ...
  const onEvent = (eventName, metadata) => {
    ...
    const defaultDataWithoutInstit = { eventName, plaidRequestId: metadata.request_id }
    const defaultData = { ...defaultDataWithoutInstit, institution: metadata.institution_name }
    ...
    switch (eventName) {
      case PlaidEventName.OPEN:
        AnalyticsManager.main.logEvent(mercadoEventName, defaultDataWithoutInstit)
        break;
      ...
      case PlaidEventName.EXIT:
        ...
        AnalyticsManager.main.logEvent(mercadoEventName, { ...dataWithErrors, exitStatus: metadata.exit_status })
        break;
  ...
  useEffect(() => {
    createPaymentAttempt(orderId, deviceId)
      .then(res => {
        ...
        AnalyticsManager.main.logEvent(AnalyticsEvent.CREATE_PAYMENT_ATTEMPT, { paymentAttemptId: payment_attempt_id })
