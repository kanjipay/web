...
function MerchantAccountPage (props) { 
    ...
    const formattedSortCode = merchantData.sort_code.slice(0, 2) + '-' + merchantData.sort_code.slice(2, 4) + '-' + merchantData.sort_code.slice(4, 6)
    ...
    return (
        ...
        <div className="MerchantAccount__imageContainer">
        <AsyncImage
          imageRef={getMerchantStorageRef(merchantData.id, merchantData.photo)}
          className='MerchantAccount__image'
        ...
        />
          ...
          <Spacer y={2} />
          <TextLine leftComponent='Display Name' rightComponent={merchantData.display_name}/>
          <TextLine leftComponent='Tags' rightComponent={merchantData.tags.join(" · ")}/>
          <TextLine leftComponent='Sort Code' rightComponent={formattedSortCode}/>
          <TextLine leftComponent='Account Number' rightComponent={merchantData.account_number}/>
          <TextLine leftComponent='Business Name' rightComponent={merchantData.company_name}/>
