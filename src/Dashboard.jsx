...
function MerchantDashboard() {
  ...
  if (orderList && merchant) {
    return <EditList {...{ orderListId, merchant, onCloseOrderList, userId}}></EditList>;
  } else if(orderList) {
    return (
      <div>
        <ErrorMessage errorCode={error}></ErrorMessage>
        <JoinList users={orderList.users} {...{orderListId, onSelectUser, onCloseOrderList, userId}}></JoinList>
      </div>
    );
  }
  return (
